...
const PATHS = {
  ...
  again: '<path d="M4 12a8 8 0 0113.7-5.2M20 12a8 8 0 01-13.7 5.2"/><path d="M18 3.5V7h-3.5M6 20.5V17h3.5"/>',
  lock: '<rect x="5" y="11" width="14" height="9" rx="2.5"/><path d="M8 11V8a4 4 0 018 0v3"/>',
  shield: '<path d="M12 3l7 2.5v5.2c0 4.6-3 7.8-7 9.3-4-1.5-7-4.7-7-9.3V5.5z"/><path d="M9 11.5l2.2 2.2L15.5 9.5"/>',
